...
img_normal = plt.imread(
    r'PATH\CBIS_DDSM_Image_Processing\manifest-1667995631662\CBIS-DDSM\Calc-Test_P_00077_LEFT_CC\anotherimage.png')

# plt.imshow(img, cmap='gray')
# plt.show()

img_cropped = plt.imread(
    r"PATH\CBIS_DDSM_Image_Processing\outputImages\cropped_image2.png")
